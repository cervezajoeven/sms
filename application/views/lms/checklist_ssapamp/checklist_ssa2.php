               ...
               <div class="">
                  <form id='frm_conduct_grades' action="<?php echo site_url('lms/conduct/save_conduct_grades_numeric') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                     ...
                     <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo form_error('class_record_quarterly'); ?> Student Checklist2</h3>
                     </div>
                                                ...
                                                <table class="table table-striped table-bordered table-hover example nowrap" cellspacing="0" width="100%" id="Tablesample">
                                                   <thead>
                                                      <tr>
                                                         <th></th>
                                                         <th colspan="4">
                                                            <center>PERIODIC RATINGS</center>
                                                         </th>
                                                      </tr>
                                                      <tr>
                                                         <th></th>
                                                   ...
                                                   ?>
                                                      <tr>
                                                         ...
                                                         ?>
                                                            ...
                                                            <td class="1<?php echo $tclass; ?>">
                                                               <center><input type="text" style="border: none" name="1st[]" id="1_<?php echo $class ?>" value="<?php echo $p1; ?>" onchange="calculateSum3('<?php echo $class ?>',<?php echo $cdid ?>,'<?php echo $row->groupclass; ?>')" class="text-center <?php echo $class ?>" <?php if ($quarter_id == "2") echo "readonly"; ?>></center>
                                                            </td>
                                                            <td class="2<?php echo $tclass; ?>">
                                                               <center><input type="text" style="border: none" name="2nd[]" id="2_<?php echo $class ?>" value="<?php echo $p2; ?>" onchange="calculateSum3('<?php echo $class ?>',<?php echo $cdid ?>,'<?php echo $row->groupclass; ?>')" class="text-center <?php echo $class ?>" <?php if ($quarter_id == "1") echo "readonly"; ?>></center>
                                                            </td>
                                                            <td class="text-center">
                                                               <center><input class="text-center" type="text" style="border: none" name="final[]" value="<?php echo $fg; ?>" id="fin<?php echo $cdid ?>" readonly disabled="disabled"></center>
                                                            </td>
                                                            <td class="text-center">
                                                               <center><input class="text-center" type="text" style="border: none" name="lg[]" value="<?php echo ""; ?>" id="lg<?php echo $cdid ?>" readonly disabled="disabled"></center>
                                                            </td>
                                                         <?php
                                                         } else {
                                                         ?>
                                                            <td>
                                                               <center><input class="text-center" type="text" style="border: none" name="<?php echo $row->alpha; ?>1" id="subject_<?php echo $row->alpha ?>1" readonly disabled="disabled" class="subject_<?php echo $row->alpha ?>"></center>
                                                            </td>
                                                            <td>
                                                               <center><input class="text-center" type="text" style="border: none" name="<?php echo $row->alpha; ?>2" id="subject_<?php echo $row->alpha ?>2" readonly disabled="disabled" class="subject_<?php echo $row->alpha ?>"></center>
                                                            </td>
                                                            <td class="text-center">
                                                               <center><input class="text-center" type="text" style="border: none" name="<?php echo $row->alpha; ?>final" id="final_<?php echo $row->alpha ?>" readonly disabled="disabled"></center>
                                                            </td>
                                                            <td class="text-center">
                                                               <center><input class="text-center" type="text" style="border: none" name="<?php echo $row->alpha; ?>lg" id="lg<?php echo $row->alpha ?>" readonly disabled="disabled"></center>
                                                            </td>
                                                            <!-- <td><b><?php echo $row->alpha; ?></b></td> -->
                                                         <?php    } ?>
                                                      </tr>
                                                      <?php
                                                         ...
                                                         <tr>
                                                            ...
                                                            ?>
                                                               ...
                                                               ?>
                                                                  ...
                                                                  <td class="1<?php echo $tclass; ?>">
                                                                     <center><input type="text" style="border: none" name="1st[]" value="<?php echo $p1; ?>" onchange="calculateSum3('<?php echo $class ?>',<?php echo $row1->id ?>,'<?php echo $row->groupclass; ?>')" class="text-center <?php echo $class ?>" <?php if ($quarter_id == "2") echo "readonly"; ?>></center>
                                                                  </td>
                                                                  <td class="2<?php echo $tclass; ?>">
                                                                     <center><input type="text" style="border: none" name="2nd[]" value="<?php echo $p2; ?>" onchange="calculateSum3('<?php echo $class ?>',<?php echo $row1->id ?>,'<?php echo $row->groupclass; ?>')" class="text-center <?php echo $class ?>" <?php if ($quarter_id == "1") echo "readonly"; ?>></center>
                                                                  </td>
                                                                  <td class="text-center">
                                                                     <center><input class="text-center" type="text" style="border: none" name="final[]" value="<?php echo $fg; ?>" id="fin<?php echo $row1->id ?>" readonly disabled="disabled"></center>
                                                                  </td>
                                                                  <td class="text-center">
                                                                     <center><input class="text-center" type="text" style="border: none" name="lg[]" value="<?php echo ""; ?>" id="lg<?php echo $row1->id ?>" readonly disabled="disabled"></center>
                                                                  </td>
                                                               ...
                                                               ?>
                                                                  <td class="1<?php echo $t_d_class ?>">
                                                                     <center><input class="text-center" type="text" style="border: none" name="1st1[]" id="1_<?php echo $id_class ?>" readonly disabled="disabled"></center>
                                                                  </td>
                                                                  <td class="2<?php echo $t_d_class ?>">
                                                                     <center><input class="text-center" type="text" style="border: none" name="2nd1[]" id="2_<?php echo $id_class ?>" readonly disabled="disabled"></center>
                                                                  </td>
                                                                  <td class="text-center">
                                                                     <center><input class="text-center" type="text" style="border: none" name="final1[]" readonly disabled="disabled"></center>
                                                                  </td>
                                                                  <td class="text-center">
                                                                     <center><input class="text-center" type="text" style="border: none" name="lg1[]" readonly disabled="disabled"></center>
                                                                  </td>
