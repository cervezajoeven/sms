                                    ...
                                    <div class="form-group">
                                        ...
                                        <select autofocus="" id="grade_id" name="grade" placeholder="" type="text" class="form-control filter" required="">
                                            ...
                                            <?php foreach ($classes as $key => $value) : ?>
                                                <option value="<?php echo $value['id'] ?>" <?php if($_REQUEST['grade']==$value['id']): echo 'selected'; endif; ?> ><?php echo $value['class'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select autofocus="" id="section_id" name="section" placeholder="" type="text" class="form-control filter" required="">
                                            ...
                                            <?php foreach ($sections as $key => $value) : ?>
                                                <option value="<?php echo $value['id'] ?>" <?php if($_REQUEST['section']==$value['id']): echo 'selected'; endif; ?>><?php echo $value['section'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <span class="text-danger"><?php echo form_error('content_title'); ?></span>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select autofocus="" id="subject_id" name="subject" placeholder="" type="text" class="form-control filter" required="">
                                            ...
                                            <?php foreach ($subjects as $key => $value) : ?>
                                                <option value="<?php echo $value['id'] ?>" <?php if($_REQUEST['subject']==$value['id']): echo 'selected'; endif; ?>><?php echo $value['name'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <span class="text-danger"><?php echo form_error('content_title'); ?></span>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select autofocus="" id="term_id" name="term" placeholder="" type="text" class="form-control filter" required="">
                                            ...
                                            <?php foreach ($quarters as $key => $value) : ?>
                                                <option value="<?php echo $value['id'] ?>" <?php if($_REQUEST['term']==$value['id']): echo 'selected'; endif; ?>><?php echo $value['description'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <span class="text-danger"><?php echo form_error('content_title'); ?></span>
                                    </div>
