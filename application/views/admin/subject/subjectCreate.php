               ...
               <form id="form1" action="<?php echo site_url('admin/subject/create') ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                  <div class="box-body">
                     ...
                     <div class="form-group">
                        <div class="checkbox">
                           <label>
                              <input type="checkbox" name="reportcard" <?php echo ($subject['in_report_card'] == true ? 'CHECKED' : ''); ?>>Include in Report Card
                           </label>
                        </div>

                        <span class="text-danger"><?php echo form_error('reportcard'); ?></span>
                     </div>
                  </div>
