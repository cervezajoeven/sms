...
<?php $parent_data = $this->session->userdata()['student']; ?>
<head>
    <meta charset="utf-8">
                ...
                <ul class="sidebar-menu verttop38">
                    ...
                    ?>
                        ...
                        <li class="treeview <?php echo set_Topmenu('Fees'); ?>">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?php echo set_Submenu('parent/kampus_pay/payment'); ?>"><a href="<?php echo site_url('lms_v2/payment/payment/initialize/'.$parent_data['id'].'/'.$parent_data['role'].'/payment');?>"><i class="fa fa-angle-double-right"></i>Payment</a></li>
                                <li class="<?php echo set_Submenu('parent/kampus_pay/payment_history'); ?>"><a href="<?php echo site_url('lms_v2/payment/payment_history/initialize/'.$parent_data['id'].'/'.$parent_data['role'].'/payment_history');?>"><i class="fa fa-angle-double-right"></i>Payment History</a></li>
                            </ul>
                        </li>
                    <?php
                    }
