                            ...
                            <li class="treeview <?php echo set_Topmenu('Downloads'); ?>">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="<?php echo set_Submenu('lms/assessment'); ?>"><a href="<?php echo base_url(); ?>lms/assessment/index"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('assessment'); ?></a></li>
                                     ...
                                     <li class="<?php echo set_Submenu('content/assignment'); ?>"><a href="<?php echo base_url(); ?>lms/survey/index"><i class="fa fa-angle-double-right"></i>Google Meet</a></li>
                                     <li class="<?php echo set_Submenu('content/assignment'); ?>"><a href="<?php echo base_url(); ?>user/conference"><i class="fa fa-angle-double-right"></i>Zoom Meeting</a></li>
