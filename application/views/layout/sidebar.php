                ...
                if (($this->rbac->hasPrivilege('upload_content', 'can_view'))) {
                    ...
                    <li class="treeview <?php echo set_Topmenu('Download Center'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="<?php echo set_Submenu('content/virtual'); ?>"><a href="<?php echo base_url(); ?>admin/conference/timetable"><i class="fa fa-angle-double-right"></i> Zoom Live Class</a></li>
