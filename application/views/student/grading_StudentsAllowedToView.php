                                    ...
                                    <tbody>
                                        <?php if (!empty($resultlist)) { 
                                            ...
                                            foreach($resultlist as $row) {
                                                ...
                                                echo "<td class='text-center'><input type=\"hidden\" name=\"q1hidden[]\" value=".$row->id."_".$row->session_id."_".$row->q1."><input type=\"checkbox\" name=\"q1[]\" ".($row->first == true ? 'CHECKED' : '')." value=".$row->id."_".$row->session_id."_".$row->q1."></td>\r\n";
                                                echo "<td class='text-center'><input type=\"hidden\" name=\"q2hidden[]\" value=".$row->id."_".$row->session_id."_".$row->q2."><input type=\"checkbox\" name=\"q2[]\" ".($row->second == true ? 'CHECKED' : '')." value=".$row->id."_".$row->session_id."_".$row->q2."></td>\r\n";
                                                echo "<td class='text-center'><input type=\"hidden\" name=\"q3hidden[]\" value=".$row->id."_".$row->session_id."_".$row->q3."><input type=\"checkbox\" name=\"q3[]\" ".($row->third == true ? 'CHECKED' : '')." value=".$row->id."_".$row->session_id."_".$row->q3."></td>\r\n";
                                                echo "<td class='text-center'><input type=\"hidden\" name=\"q4hidden[]\" value=".$row->id."_".$row->session_id."_".$row->q4."><input type=\"checkbox\" name=\"q4[]\" ".($row->fourth == true ? 'CHECKED' : '')." value=".$row->id."_".$row->session_id."_".$row->q4."></td>\r\n";
                                                echo "</tr>\r\n";
                                            }
                                        } ?>
                                    </tbody>
