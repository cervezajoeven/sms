                                    ...
                                    <div class="box-body">
                                       <div class="table-responsive">
                                          ...
                                          <table id="class_record" class="table table-striped table-bordered table-hover classrecord nowrap">
                                             <thead>
                                                <tr>
                                                   <th class="text-left">Subject-s</th>
                                                   <th class="text-left">1st Semester</th>
                                                   <th class="text-left">2nd Semester</th>
                                                   <?php
                                             ...
                                             <tbody>
                                                ...
                                                foreach ($resultlist as $row) {
                                                   ...
                                                   echo "<td class='text-center" . ($row->Q1 < 75 ? " text-danger" : ($row->Q1 >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q1 == 0 ? '' : round($row->Q1)) . "</b></td>\r\n";
                                                   echo "<td class='text-center" . ($row->Q2 < 75 ? " text-danger" : ($row->Q2 >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q2 == 0 ? '' : round($row->Q2)) . "</b></td>\r\n";
                                             ...
                                             <tfoot>
                                                <tr>
                                                   ...
                                                   <!-- <th class='text-center'><?php echo $lettergrade ?></td>    -->
                                                </tr>
                                             </tfoot>
                                          </table>
                                          <?php //} 
