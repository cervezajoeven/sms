                                    ...
                                    <div class="col-md-12">
                                       <div class="box box-warning">
                                          <div class="box-header ptbnull">
                                             ...
                                             <div class="box-tools pull-right"><a href="<?php echo base_url('report/student_report_card_ssapamp') . '?session_id=' . $the_session_id . '&class_id=' . $the_class_id . '&section_id=' . $the_section_id . '&student_id=' . $the_student_id ?>" target="_blank"><button class="btn btn-primary btn-sm"><i class="fa fa-print"></i>&nbsp;Print Report Card</button></a></div>
                                          </div>
                                          <div class="box-body">
                                             <div class="box-body box-profile">
                                                <h3 class="profile-username text-center"><?php echo $student['firstname'] . " " . $student['lastname']; ?></h3>
                                                ...
                                                <table id="class_record" class="table table-striped table-bordered table-hover classrecord nowrap">
                                                   ...
                                                   <tbody>
                                                      ...
                                                      foreach ($resultlist as $row) {
                                                         ...
                                                         echo "<td class='text-center" . ($average < 75 ? " text-danger" : ($average >= 90 ? " text-success" : "")) . "'><b>" . ($average == 0 ? '' : $final) . "</b></td>\r\n";
