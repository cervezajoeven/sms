    ...
    public function edit($id)
    {
        ...
        else 
        {
            ...
            $data = array(
                ...
                'measurement_date'    => date('Y-m-d', $this->customlib->datetostrtotime($this->input->post('measurement_date'))), //$this->customlib->dateFormatToYYYYMMDD($this->input->post('measure_date')),
                'religion'            => $this->input->post('religion'),
                'dob'                 => date('Y-m-d', $this->customlib->datetostrtotime($this->input->post('dob'))), //$this->customlib->dateFormatToYYYYMMDD($this->input->post('dob')),
                'admission_date'      => date('Y-m-d', $this->customlib->datetostrtotime($this->input->post('admission_date'))), //$this->customlib->dateFormatToYYYYMMDD($this->input->post('admission_date')),
