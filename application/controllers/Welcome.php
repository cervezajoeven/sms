                    ...
                    else 
                    {
                        ...
                        if (!$alreadyEnrolled)
                        {
                            ...
                            $data = array(
                                ...
                                'dob'                 => date('Y-m-d', strtotime($old_student_data->dob)), // $this->customlib->dateFormatToYYYYMMDD($this->input->post('dob')),
                                ...
                                'father_dob'                       => date('Y-m-d', strtotime($old_student_data->father_mobile)), // $this->customlib->dateFormatToYYYYMMDD($this->input->post('father_dob')),
                                ...
                                'mother_dob'                       => date('Y-m-d', strtotime($old_student_data->mother_dob)), // $this->customlib->dateFormatToYYYYMMDD($this->input->post('mother_dob')),
                                ...
                                'dom'                        => date('Y-m-d', strtotime($old_student_data->dom)), // $this->customlib->dateFormatToYYYYMMDD($this->input->post('dom')),
