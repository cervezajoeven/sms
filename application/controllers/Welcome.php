                ...
                if ($document_validate) {
                    ...
                    if ($enrollment_type == 'old')
                    {
                        ...
                        $data = array(
                            ...
                            'dob'                 => date('Y-m-d', strtotime($old_student_data->dob)), //$this->input->post('dob') != '' ? date('Y-m-d', strtotime($this->input->post('dob'))) : date('Y-m-d', strtotime($old_student_data->dob)),
                            ...
                            'gender'              => $old_student_data->gender, //$this->input->post('gender') != '' ? $this->input->post('gender') : $old_student_data->gender,
